...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::get('suivi/{id}/export/pdf', [SuiviController::class, 'exportEnreprisePdf'])->name('suivi.entreprise.export.pdf');
    Route::get('suivi/{id}/export/excel', [SuiviController::class, 'exportEntrepriseExcel'])->name('suivi.entreprise.export.excel');
});
