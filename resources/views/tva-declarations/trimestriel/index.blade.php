                    ...
                    <div class="col-12 text-right">
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="exportDropdown">
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="{{ route('tva-declaration.trimestrielle.export.pdf', ['search' => $search ?? '', 'periode_filter' => $periode_filter ?? '', 'sort_by' => $sort_by ?? '']) }}">
                                    <i class="tim-icons icon-paper mr-2"></i> Format PDF
                                </a>
                                <a class="dropdown-item d-flex align-items-center" href="{{ route('tva-declaration.trimestrielle.export.excel', ['search' => $search ?? '', 'periode_filter' => $periode_filter ?? '', 'sort_by' => $sort_by ?? '']) }}">
                                    <i class="tim-icons icon-chart-bar-32 mr-2"></i> Format Excel
                                </a>
                                <div class="dropdown-divider"></div>
                                <h6 class="dropdown-header">Page courante uniquement</h6>
                                <a class="dropdown-item d-flex align-items-center" href="{{ route('tva-declaration.trimestrielle.export.pdf', ['search' => $search ?? '', 'periode_filter' => $periode_filter ?? '', 'sort_by' => $sort_by ?? '', 'page' => $declarations->currentPage()]) }}">
                                    <i class="tim-icons icon-paper mr-2"></i> Format PDF
                                </a>
                                <a class="dropdown-item d-flex align-items-center" href="{{ route('tva-declaration.trimestrielle.export.excel', ['search' => $search ?? '', 'periode_filter' => $periode_filter ?? '', 'sort_by' => $sort_by ?? '', 'page' => $declarations->currentPage()]) }}">
                                    <i class="tim-icons icon-chart-bar-32 mr-2"></i> Format Excel
                                </a>
                            </div>
                        </div>
